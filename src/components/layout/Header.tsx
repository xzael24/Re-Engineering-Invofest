import { Trophy, Presentation, Monitor, Mic, UserCircle } from 'lucide-react';
...
export default function Header() {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md shadow-[0_1px_5px_rgba(0,0,0,0.05)] transition-all duration-300 font-sans">
        <div className="w-full max-w-7xl mx-auto px-6 lg:px-12">
          <div className="flex items-center justify-between h-20">
            <Link to="/" className="flex-shrink-0 cursor-pointer flex items-center h-full">
